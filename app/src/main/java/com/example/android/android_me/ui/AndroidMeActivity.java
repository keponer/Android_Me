...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bodyPartFragment.setImagesIds(AndroidImageAssets.getBodies());
        legFragment.setImagesIds(AndroidImageAssets.getLegs());

        headFragment.setImagePosition(1);
        bodyPartFragment.setImagePosition(1);
        legFragment.setImagePosition(1);
